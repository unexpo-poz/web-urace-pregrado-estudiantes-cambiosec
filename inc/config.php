<?php
$enProduccion		= true;
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/cambiosec/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso		= '2023-2';
$tLapso				= ' Lapso '.$lapsoProceso;

$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/cambio/cambiosec-'.$lapsoProceso.'.log';
